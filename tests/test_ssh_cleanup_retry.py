...
class TestSSHCleanupRetry(unittest.TestCase):
    ...
    def test_rmtree_retries_transient_failure(self, sleep):
    ...
    @patch("dpdispatcher.contexts.ssh_context.time.sleep")
    def test_rmtree_propagates_non_transient_failure(self, sleep):
    ...
    @patch("dpdispatcher.contexts.ssh_context.time.sleep")
    def test_rmtree_retries_nfs_busy_failure(self, sleep):
        self.context.block_checkcall.side_effect = [
    ...
    def test_async_cleanup_does_not_retry(self):
